...
if __name__ == "__main__":
    from adaptive_AU_config import adaptive_AU_relation, adaptive_AU_database
    import AU.config as config

    adaptive_AU_database()
    # adaptive_AU_relation()
    print(config.AU_SQUEEZE)
    AU_couple = get_zip_ROI_AU()
    print(list(AU_couple.values()))
    AU_couple_child = get_AU_couple_child(AU_couple)
    print(list(AU_couple_child.values()))
